...
class AnloukScreen extends StatefulWidget {
  static String routeName = '/AnloukScreen';
  const AnloukScreen({Key? key}) : super(key: key);

  @override
  State<AnloukScreen> createState() => _AnloukScreenState();
}

class _AnloukScreenState extends State<AnloukScreen> {
  @override
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text("អន្លក់គ្រឿងស្រុកស្រែខេត្តតាកែវ",
                                            style: TextStyle(
                                                fontSize: 17,
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://4.bp.blogspot.com/-G03BX2-HErM/Xlc_ceMdfaI/AAAAAAAAVg4/dsZspj8njOooh8m_MRivKHRxIfN3rwodACLcBGAsYHQ/s1600/sp78963%2B%25282%2529.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://m.postkhmer.com/sites/default/files/styles/full-screen_watermarked/public/field/image/kreing.jpg?itok=nQCoz1-l",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://kohsantepheap.tv/wp-content/uploads/2020/05/27749905_562603540766366_5281293467083015458_n.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
