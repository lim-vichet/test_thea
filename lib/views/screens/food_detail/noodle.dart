...
class NoodleScreen extends StatefulWidget {
  static String routeName = '/NoodleScreen';
  const NoodleScreen({Key? key}) : super(key: key);

  @override
  State<NoodleScreen> createState() => _NoodleScreenState();
}

class _NoodleScreenState extends State<NoodleScreen> {
  @override
                        ...
                        child: CircleAvatar(
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundImage: NetworkImage(
                                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSB9lJ9AtzwIsXXMXCTTzc1WgB0y5XF2PRdiTlcim_wzEdGji_-cnTSBVTOKrhV0IOTCFk&usqp=CAU"),
                          ),
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text("នំបញ្ចុកសម្លរខ្មែរអ្នកតាកែវ",
                                            style: TextStyle(
                                                fontSize: 17,
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://images.deliveryhero.io/image/fd-kh/LH/iic6-hero.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://images.deliveryhero.io/image/fd-kh/LH/i83m-hero.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://images.deliveryhero.io/image/fd-kh/LH/k25q-hero.jpg?width=480&height=360&quality=45",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
