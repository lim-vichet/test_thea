...
class MchouScreen extends StatefulWidget {
  static String routeName = '/MchouScreen';
  const MchouScreen({Key? key}) : super(key: key);

  @override
  State<MchouScreen> createState() => _MchouScreenState();
}

class _MchouScreenState extends State<MchouScreen> {
  @override
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text("ម្ជុរថ្មី ស្រីចង់ ប្រចាំខេត្តតាកែវ",
                                            style: TextStyle(
                                                fontSize: 17,
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://images.deliveryhero.io/image/fd-kh/LH/np1w-hero.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://images.deliveryhero.io/image/fd-kh/LH/e9re-hero.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://kohsantepheap.tv/wp-content/uploads/2016/12/IMG_4248.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
