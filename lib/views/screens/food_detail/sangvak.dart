...
class SangvakScreen extends StatefulWidget {
  static String routeName = '/SangvakScreen';
  const SangvakScreen({Key? key}) : super(key: key);

  @override
  State<SangvakScreen> createState() => _SangvakScreenState();
}

class _SangvakScreenState extends State<SangvakScreen> {
  @override
                        ...
                        child: CircleAvatar(
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundImage: NetworkImage(
                                "https://refile.tnaot.com/image/2019/05/26/9642e5c7f17c4eb188cce4cc1ad24cb1.jpg?x-oss-process=image/watermark,image_RS5wbmc_eC1vc3MtcHJvY2Vzcz1pbWFnZS9yZXNpemUsUF8yMA"),
                          ),
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://images.khmer24.co/22-01-11/s-714139---1641908621-22015858-b.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTAE5pxuhIaohpmV5oXyiF4e5IbLITb9Kg3HlhO7q6TaeSlJmzb6VkOYaa2kFopm_XpZi8&usqp=CAU",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://1.bp.blogspot.com/-kIuQ2B34FZI/XZWxs-TgUiI/AAAAAAABp28/pSzAdh1vO2cGXgXHJrXduB3mltF0eWa_wCLcBGAsYHQ/s1600/1%2B%25283%2529.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
