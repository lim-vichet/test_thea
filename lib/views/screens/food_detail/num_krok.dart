...
class NumKrokScreen extends StatefulWidget {
  static String routeName = '/NumKrokScreen';
  const NumKrokScreen({Key? key}) : super(key: key);

  @override
  State<NumKrokScreen> createState() => _NumKrokScreenState();
}

class _NumKrokScreenState extends State<NumKrokScreen> {
  @override
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://refile.tnaot.com/image/2019/04/09/6cb67c2196f34d7ba0c14d02fb6dc7db.jpg?x-oss-process=image/watermark,image_RS5wbmc_eC1vc3MtcHJvY2Vzcz1pbWFnZS9yZXNpemUsUF8yMA",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://i.ytimg.com/vi/tNQ0wd20-ZE/maxresdefault.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://i.ytimg.com/vi/USPh4ZPMr0o/maxresdefault.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
