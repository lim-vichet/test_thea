...
class TrapeScreen extends StatefulWidget {
  static String routeName = '/TrapeScreen';
  const TrapeScreen({Key? key}) : super(key: key);

  @override
  State<TrapeScreen> createState() => _TrapeScreenState();
}

class _TrapeScreenState extends State<TrapeScreen> {
  @override
                        ...
                        child: CircleAvatar(
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundImage: NetworkImage(
                                "https://i.ytimg.com/vi/oDyVJN_BRyo/maxresdefault.jpg"),
                          ),
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://i.ytimg.com/vi/kKCKuRn3Cnw/maxresdefault.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4yHbDMzn8IhkmXrSd-n8nkmZPxAcKF7TYuQ&usqp=CAU",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://i.ytimg.com/vi/fZIxmaRN140/maxresdefault.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
