...
class PrahokBeefBellyScreen extends StatefulWidget {
  static String routeName = '/PrahokBeefBellyScreen';
  const PrahokBeefBellyScreen({Key? key}) : super(key: key);

  @override
  State<PrahokBeefBellyScreen> createState() => _PrahokBeefBellyScreenState();
}

class _PrahokBeefBellyScreenState extends State<PrahokBeefBellyScreen> {
  @override
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://i.ytimg.com/vi/iSgQhh6Yg78/maxresdefault.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://kohsantepheap.tv/wp-content/uploads/2017/02/IMG_8330.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://1.bp.blogspot.com/-jLVZPh6IWdw/XRbWs8PVjDI/AAAAAAAAO3A/XHFc_E7N9vMelQxkO0VeWbq17Dl8Yk0HgCLcBGAs/s1600/10e.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
