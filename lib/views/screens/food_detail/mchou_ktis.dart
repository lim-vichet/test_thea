...
class MchouKtisScreen extends StatefulWidget {
  static String routeName = '/MchouKtisScreen';
  const MchouKtisScreen({Key? key}) : super(key: key);

  @override
  State<MchouKtisScreen> createState() => _MchouKtisScreenState();
}

class _MchouKtisScreenState extends State<MchouKtisScreen> {
  @override
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text("សម្លរម្ជូរខ្ទិះខេត្តតាកែវ",
                                            style: TextStyle(
                                                fontSize: 17,
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://i.ytimg.com/vi/_UJJ0ttezNo/maxresdefault.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://i.ytimg.com/vi/e7o7uQ9cN1k/maxresdefault.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Container(
                                        height: 190,
                                        child: Image.network("https://i.ytimg.com/vi/67JzEFnmc4Y/mqdefault.jpg",
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
