...
class ArabicaScreen extends StatefulWidget {
  static String routeName = 'ArabicaScreen';
  const ArabicaScreen({Key? key}) : super(key: key);

  @override
  State<ArabicaScreen> createState() => _ArabicaScreenState();
}

class _ArabicaScreenState extends State<ArabicaScreen> {
  @override
        ...
        child: Stack(
          ...
          children: [
            Container(
              ...
              color: Colors.green,
              child: Image.network("https://media.istockphoto.com/photos/roasted-coffee-beans-falling-down-picture-id1135359711?b=1&k=20&m=1135359711&s=612x612&w=0&h=Hp1Rc1gPSCUltDVhDbV44ZKIC3lUnmW81Z_uEdfuxbE=",
                fit: BoxFit.cover,
              ),
            ),
            Container(
              ...
              child: ListView(
                children: [
                  Container(
                    ...
                    // color: Colors.pink,
                    child: Center(
                        child: Image.network("https://www.freepnglogos.com/uploads/coffee-png/coffee-png-transparent-images-png-only-31.png")
                    ),
                  ),
                  Container(
                    height: 470,
                                        ...
                                        child: CircleAvatar(
                                          ...
                                          child: CircleAvatar(
                                            ...
                                            backgroundImage: NetworkImage(
                                                "https://www.freepnglogos.com/uploads/coffee-png/coffee-png-transparent-images-png-only-31.png"),
                                          ),
                                        )
                                    ),
                                    Container(
