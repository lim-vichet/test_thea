...
class BrownScreen extends StatefulWidget {
  static String routeName = 'BrownScreen';
  const BrownScreen({Key? key}) : super(key: key);
        ...
        child: Stack(
          ...
          children: [
            Container(
              ...
              color: Colors.green,
              child: Image.network("https://thumbs.dreamstime.com/b/plain-blue-background-pink-gradient-wallpaper-image-text-layering-plain-blue-background-gradient-125009166.jpg",
                fit: BoxFit.cover,
              ),
            ),
            Container(
              ...
              child: ListView(
                children: [
                  Container(
                    height: 250,
                    margin: EdgeInsets.only(bottom: 50.px, top: 50.px, right: 10.px, left: 10.px),
                    // color: Colors.pink,
                    child: Center(
                        child: Image.network("https://olo-images-live.imgix.net/ea/ea9cfddaff974c0b8dc4076888154da4.png?auto=format%2Ccompress&q=60&cs=tinysrgb&w=528&h=352&fit=crop&s=9ff8beac29a9715b388f94b49db06bad")
                    ),
                  ),
                  Container(
                    height: 470,
