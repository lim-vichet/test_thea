...
class SubCategoryDetail extends StatefulWidget {
  static String routeName = 'SubCategoryDetail';
  const SubCategoryDetail({Key? key}) : super(key: key);

  @override
  State<SubCategoryDetail> createState() => _SubCategoryDetailState();
}

class _SubCategoryDetailState extends State<SubCategoryDetail>  with SingleTickerProviderStateMixin {
