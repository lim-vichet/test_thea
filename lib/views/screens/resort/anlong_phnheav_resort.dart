...
class AnlongPhnheavResortScreen extends StatefulWidget {
  static String routeName = 'AnlongPhnheavResortScreen';
  const AnlongPhnheavResortScreen({Key? key}) : super(key: key);

  @override
  State<AnlongPhnheavResortScreen> createState() => _AnlongPhnheavResortScreenState();
}

class _AnlongPhnheavResortScreenState extends State<AnlongPhnheavResortScreen> with SingleTickerProviderStateMixin{
        ...
        child: Stack(
          ...
          children: [
            Container(
              ...
              child: Image.network("https://cdn.sabay.com/cdn/media.sabay.com/media/Kley-Kley/KK-Social/11-04-2018/1_medium.jpg",
                fit: BoxFit.cover,
