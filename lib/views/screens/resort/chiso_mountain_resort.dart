...
class ChisoMountainResortScreen extends StatefulWidget {
  static String routeName = 'ChisoMountainResortScreen';
  const ChisoMountainResortScreen({Key? key}) : super(key: key);

  @override
  State<ChisoMountainResortScreen> createState() => _ChisoMountainResortScreenState();
}

class _ChisoMountainResortScreenState extends State<ChisoMountainResortScreen> with SingleTickerProviderStateMixin{
