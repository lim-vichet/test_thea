...
class NaturalLakeScreen extends StatefulWidget {
  static String routeName = 'NaturalLakeScreen';
  const NaturalLakeScreen({Key? key}) : super(key: key);

  @override
  State<NaturalLakeScreen> createState() => _NaturalLakeScreenState();
}

class _NaturalLakeScreenState extends State<NaturalLakeScreen> with SingleTickerProviderStateMixin{
        ...
        child: Stack(
          ...
          children: [
            Container(
              ...
              child: Image.network("https://www.guidetrip.info/asset/img/gallery_album/5d2ed504df7b7.jpg",
                fit: BoxFit.cover,
