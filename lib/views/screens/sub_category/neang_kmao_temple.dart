...
class NeangKmaoTempleScreen extends StatefulWidget {
  static String routeName = 'NeangKmaoTempleScreen';
  const NeangKmaoTempleScreen({Key? key}) : super(key: key);

  @override
  State<NeangKmaoTempleScreen> createState() => _NeangKmaoTempleScreenState();
}

class _NeangKmaoTempleScreenState extends State<NeangKmaoTempleScreen> {
  @override
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: Image.network(
                          "https://upload.wikimedia.org/wikipedia/km/8/83/Prasat_neang_khmao.jpg",
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
