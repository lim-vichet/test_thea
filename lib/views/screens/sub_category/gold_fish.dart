...
class GoldFishScreen extends StatefulWidget {
  static String routeName = 'GoldFishScreen';
  const GoldFishScreen({Key? key}) : super(key: key);

  @override
  State<GoldFishScreen> createState() => _GoldFishScreenState();
}

class _GoldFishScreenState extends State<GoldFishScreen> {
  @override
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: Image.network(
                          "https://www.guidetrip.info/asset/img/gallery_resort/6097fd8d1a8cb.jpeg",
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
