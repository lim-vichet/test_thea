...
class TamaoMountainScreen extends StatefulWidget {
  static String routeName = 'TamaoMountainScreen';
  const TamaoMountainScreen({Key? key}) : super(key: key);

  @override
  State<TamaoMountainScreen> createState() => _TamaoMountainScreenState();
}

class _TamaoMountainScreenState extends State<TamaoMountainScreen> {
  @override
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: Image.network(
                          "https://i.pinimg.com/originals/83/63/f5/8363f506fbfda64e9fd3be81480101c7.jpg",
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
