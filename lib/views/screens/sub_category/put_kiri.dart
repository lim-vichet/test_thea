...
class PutKiriScreen extends StatefulWidget {
  static String routeName = 'PutKiriScreen';
  const PutKiriScreen({Key? key}) : super(key: key);

  @override
  State<PutKiriScreen> createState() => _PutKiriScreenState();
}

class _PutKiriScreenState extends State<PutKiriScreen> {
  @override
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: Image.network(
                          "https://i.ytimg.com/vi/sS5hM976Vfs/maxresdefault.jpg",
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
