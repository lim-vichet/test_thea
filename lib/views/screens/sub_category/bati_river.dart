...
class BatiRiverScreen extends StatefulWidget {
  static String routeName = 'BatiRiverScreen';
  const BatiRiverScreen({Key? key}) : super(key: key);

  @override
  State<BatiRiverScreen> createState() => _BatiRiverScreenState();
}

class _BatiRiverScreenState extends State<BatiRiverScreen> {
  @override
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: Image.network(
                          "https://www.bambootravel.co.uk/files/img_cache/53583/1400__1521561026_Koh-Andet-Eco-Resort-2-130.jpg?1521561031",
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
