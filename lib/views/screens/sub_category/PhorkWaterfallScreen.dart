...
class PhorkWaterfallScreen extends StatefulWidget {
  static String routeName = 'PhorkWaterfallScreen';
  const PhorkWaterfallScreen({Key? key}) : super(key: key);

  @override
  State<PhorkWaterfallScreen> createState() => _PhorkWaterfallScreenState();
}

class _PhorkWaterfallScreenState extends State<PhorkWaterfallScreen> {
  @override
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: Image.network(
                          "https://cms.dmpcdn.com/cdn-cgi/image/fit=cover,quality=85,f=auto/https://cms.dmpcdn.com/article/2020/12/29/67928a90-49b4-11eb-89e4-35f1a97d3869_original.jpg",
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
