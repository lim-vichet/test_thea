...
class TnortTeScreen extends StatefulWidget {
  static String routeName = 'TnortTeScreen';
  const TnortTeScreen({Key? key}) : super(key: key);

  @override
  State<TnortTeScreen> createState() => _TnortTeScreenState();
}

class _TnortTeScreenState extends State<TnortTeScreen> {
  @override
