...
class TakeoLobsterScreen extends StatefulWidget {
  static String routeName = 'TakeoLobsterScreen';
  const TakeoLobsterScreen({Key? key}) : super(key: key);

  @override
  State<TakeoLobsterScreen> createState() => _TakeoLobsterScreenState();
}

class _TakeoLobsterScreenState extends State<TakeoLobsterScreen> {
  @override
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: Image.network(
                          "https://m.postkhmer.com/sites/default/files/styles/full-screen/public/field/image/20141205_22a.jpg?itok=sMsb7SCK",
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
