...
class WaterSprayScreen extends StatefulWidget {
  static String routeName = 'WaterSprayScreen';
  const WaterSprayScreen({Key? key}) : super(key: key);

  @override
  State<WaterSprayScreen> createState() => _WaterSprayScreenState();
}

class _WaterSprayScreenState extends State<WaterSprayScreen> with SingleTickerProviderStateMixin{
