...
class TnortTeScreenDetail extends StatefulWidget {
  static String routeName = 'TnortTeScreen';
  const TnortTeScreenDetail({Key? key}) : super(key: key);

  @override
  State<TnortTeScreenDetail> createState() => _TnortTeScreenState();
}

class _TnortTeScreenState extends State<TnortTeScreenDetail> with SingleTickerProviderStateMixin{
