...
class DuckRidingScreen extends StatefulWidget {
  static String routeName = 'DuckRidingScreen';
  const DuckRidingScreen({Key? key}) : super(key: key);

  @override
  State<DuckRidingScreen> createState() => _DuckRidingScreenState();
}

class _DuckRidingScreenState extends State<DuckRidingScreen> with SingleTickerProviderStateMixin{
