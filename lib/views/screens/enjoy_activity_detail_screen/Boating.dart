...
class BoatingScreen extends StatefulWidget {
  static String routeName = 'BoatingScreen';
  const BoatingScreen({Key? key}) : super(key: key);

  @override
  State<BoatingScreen> createState() => _BoatingScreenState();
}

class _BoatingScreenState extends State<BoatingScreen> with SingleTickerProviderStateMixin{
