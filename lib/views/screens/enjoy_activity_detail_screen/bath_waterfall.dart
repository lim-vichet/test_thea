...
class BathWaterfall extends StatefulWidget {
  static String routeName = 'BathWaterfall';
  const BathWaterfall({Key? key}) : super(key: key);

  @override
  State<BathWaterfall> createState() => _BathWaterfallState();
}

class _BathWaterfallState extends State<BathWaterfall> with SingleTickerProviderStateMixin{
