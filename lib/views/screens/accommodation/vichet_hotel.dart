...
class VichetHotelScreen extends StatefulWidget {
  static String routeName = 'VichetHotelScreen';
  const VichetHotelScreen({Key? key}) : super(key: key);

  @override
  State<VichetHotelScreen> createState() => _VichetHotelScreenState();
}

class _VichetHotelScreenState extends State<VichetHotelScreen> with SingleTickerProviderStateMixin{
