...
class ChamkaHouseScreen extends StatefulWidget {
  static String routeName = 'ChamkaHouseScreen';
  const ChamkaHouseScreen({Key? key}) : super(key: key);

  @override
  State<ChamkaHouseScreen> createState() => _ChamkaHouseScreenState();
}

class _ChamkaHouseScreenState extends State<ChamkaHouseScreen> with SingleTickerProviderStateMixin{
