...
class VichetHolidayHomeScreen extends StatefulWidget {
  static String routeName = 'VichetHolidayHomeScreen';
  const VichetHolidayHomeScreen({Key? key}) : super(key: key);

  @override
  State<VichetHolidayHomeScreen> createState() => _VichetHolidayHomeScreenState();
}

class _VichetHolidayHomeScreenState extends State<VichetHolidayHomeScreen> with SingleTickerProviderStateMixin{
