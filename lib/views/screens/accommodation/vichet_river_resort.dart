...
class VichetRiverResortScreen extends StatefulWidget {
  static String routeName = 'VichetRiverResortScreen';
  const VichetRiverResortScreen({Key? key}) : super(key: key);

  @override
  State<VichetRiverResortScreen> createState() => _VichetRiverResortScreenState();
}

class _VichetRiverResortScreenState extends State<VichetRiverResortScreen> with SingleTickerProviderStateMixin{
